...
public class CategoryService {
    ...
    private static CategoryService getObject (JSONObject jsonObject){
        return new Gson().fromJson(jsonObject.toString(),CategoryService.class);
    }

    public  static ArrayList<CategoryService> getList(String jsonArray) throws JSONException {
        ArrayList<CategoryService> arrayList = new ArrayList<>();
        Type type = new TypeToken<List<CategoryService>>(){}.getType();
