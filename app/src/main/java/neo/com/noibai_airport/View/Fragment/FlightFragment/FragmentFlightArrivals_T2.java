...
public class FragmentFlightArrivals_T2 extends BaseFragment implements ImlFlight.View,
        SwipeRefreshLayout.OnRefreshListener {

    public static FragmentFlightArrivals_T2 fragment;

    public static synchronized FragmentFlightArrivals_T2 getInstance() {
        if (fragment == null) {
            fragment = new FragmentFlightArrivals_T2();
        }
        return (fragment);
    }
    ...
    private void initData() {
        ...
        mPresenter.get_list_flight(sUserId, "", "", "A",
        currentDateandTime, "","asc", "" + iPage, ""+ iIndex, "T2");
    }
