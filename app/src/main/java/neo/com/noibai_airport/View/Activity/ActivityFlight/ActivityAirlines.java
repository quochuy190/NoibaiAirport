...
import neo.com.noibai_airport.View.Activity.AirlineInfo.ActivityListAirline;
import neo.com.noibai_airport.View.Activity.AirlineInfo.ActivityListIntenational;
 ...
 * @since 1.0
 */
public class ActivityAirlines extends BaseActivity {
    @Override
    ...
    public void initAppbar() {
        ...
        txt_title.setText(R.string.title_airline);
    ...
    private void setupViewPager(ViewPager viewPager) {
        String departures =  getString(R.string.tab_domestic);
        String arrivals =getString( R.string.tab_international);
        adapter = new AdapterViewpager(getSupportFragmentManager());
        adapter.addFragment(new ActivityListIntenational(),arrivals);
        adapter.addFragment(new ActivityListAirline(),departures );
