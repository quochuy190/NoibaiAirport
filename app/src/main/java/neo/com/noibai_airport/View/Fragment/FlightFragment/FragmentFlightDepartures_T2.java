...
public class FragmentFlightDepartures_T2 extends BaseFragment implements ImlFlight.View, SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = "FragmentFlightDeparture";
    public static FragmentFlightDepartures_T2 fragment;

    public static synchronized FragmentFlightDepartures_T2 getInstance() {
        if (fragment == null) {
            fragment = new FragmentFlightDepartures_T2();
        }
        return (fragment);
    }
