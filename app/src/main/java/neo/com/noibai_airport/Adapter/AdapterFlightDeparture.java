...
public class AdapterFlightDeparture extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterFlightDeparture(List<FlightInfo> mLisFlightInfo, List<FlightInfo> mLisFollow, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(context)
                    .inflate(R.layout.item_flight_departure, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof FlightInfoViewHoder) {
            ...
            if (objFlight.getmTime_departure() != null && objFlight.getmTime_departure().length() > 0) {
                viewHolder.txt_time_start_flight.setText(objFlight.getmTime_departure());
            } else {
    ...
    public class FlightInfoViewHoder extends RecyclerView.ViewHolder
        ...
        @BindView(R.id.txt_date_start_flight)
