...
public class AdapterListAirline_Search extends RecyclerView.Adapter<AdapterListAirline_Search.TopicViewHoder>{
    private List<AirlineInfo> listAirport;
    ...
    public AdapterListAirline_Search(List<AirlineInfo> listAirport, Context context) {
    ...
    public void onBindViewHolder(TopicViewHoder holder, int position) {
        ...
        AirlineInfo airport = listAirport.get(position);
    ...
    public void updateList(List<AirlineInfo> list){
        listAirport = list;
