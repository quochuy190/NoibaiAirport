...
public class FragmentUtil {
    ...
    public static void pushFragmentAnimationLeftToRight(FragmentActivity activity, @NonNull Fragment
            fragment, @Nullable Bundle data) {
        //    DebugLog.e("bundle data:" + data);
...
//        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    ...
    public static void addFragmentData(FragmentActivity activity, @NonNull Fragment fragment,
        ...
        fragmentTransaction.replace(R.id.frame_content, fragment, null);
        if (isAddToBackStack) {
            fragmentTransaction.addToBackStack(null);
        }
