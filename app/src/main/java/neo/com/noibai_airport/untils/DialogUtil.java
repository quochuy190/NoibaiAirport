...
//        dialog.getWindow().getAttributes().windowAnimations = R.style.DialogAnimation_2;
    ...
    public static AlertDialog showDialogJP(final Context context, String title, String message,
                                           DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                context);
    ...
    public static AlertDialog showDialogPasscode(final Context context, String title, String message,
                                                 DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                context);
     ...
     * @return
     */
    public static AlertDialog showDialogCancelable(final Context context, String title, String message,String btn_ok, String btn_Cancel,
                                                   DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                context);
        ...
        if (title != null && !title.isEmpty()) {
            alertDialogBuilder.setTitle(title);
            //alertDialogBuilder.setText(getContext().getResources().getText(resid));
        }

        alertDialogBuilder.setMessage(message);

        alertDialogBuilder.setPositiveButton(btn_ok,
                onClickListener);

        alertDialogBuilder.setNegativeButton(btn_Cancel, new DialogInterface.OnClickListener() {
            @Override
    ...
    public static AlertDialog showDialogFull(Context context, String title, String message, String okText,
                                             String cancelText, DialogInterface.OnClickListener okOnClickListener,
    ...
    public static AlertDialog showDialogComfirm(Context context, String title, String message, String okText,
    ...
    public static AlertDialog showDialogComfirmInfo(ItemClickListener context, String title, String message, String okText) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                (Context) context);
